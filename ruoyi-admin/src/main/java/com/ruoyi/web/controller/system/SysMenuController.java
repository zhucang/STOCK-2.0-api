...
public class SysMenuController extends BaseController
{
    ...
    {
        List<SysMenu> list = menuService.selectMenuList(new SysMenu(), getUserId());
    ...
    @Log(title = "导入菜单", businessType = BusinessType.DELETE)
    @RepeatSubmit
    @PostMapping(value = "/import")
    public AjaxResult importData(@RequestParam("file") MultipartFile file, boolean updateSupport) throws Exception
    {
        ExcelUtil<SysMenu> util = new ExcelUtil<SysMenu>(SysMenu.class);
        List<SysMenu> list = util.importExcel(file.getInputStream());
        String message = menuService.importSysMenu(list, updateSupport);
