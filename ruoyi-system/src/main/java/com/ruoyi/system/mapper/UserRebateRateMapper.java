 ...
 * @date 2023-11-05
 */
public interface UserRebateRateMapper 
{
    /**
     * 查询用户返佣比率配置
     * 
     ...
     * @return 用户返佣比率配置
     */
    public UserRebateRate selectUserRebateRate(UserRebateRate userRebateRate);
     ...
     * @return 结果
     */
    public int insertUserRebateRate(UserRebateRate userRebateRate);
     ...
     * @return 结果
     */
    public int updateUserRebateRate(UserRebateRate userRebateRate);
