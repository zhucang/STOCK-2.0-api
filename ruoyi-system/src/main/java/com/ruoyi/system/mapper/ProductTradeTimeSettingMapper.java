 ...
 * @date 2023-11-27
 */
public interface ProductTradeTimeSettingMapper 
{
    /**
     * 查询系统产品交易时间配置
     * 
     ...
     * @return 系统产品交易时间配置
     */
    public ProductTradeTimeSetting selectProductTradeTimeSettingByDayAndProductType(@Param("day")Integer day, @Param("productType")Integer productType);
